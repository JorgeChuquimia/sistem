    ...
    <div class="space-y-6" x-data="{
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                <h3 class="font-bold text-gray-800 text-lg">Lista de Niveles Académicos</h3>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Gestión</th>
        ...
        @include('niveles.modals.create')
        @include('niveles.modals.edit')
        @include('niveles.modals.delete')
    </div>
</x-app-layout>
