<div x-show="openCreateModal" x-transition:enter="transition ease-out duration-300"
    ...
    <div @click.away="openCreateModal = false"
        ...
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-bold text-gray-900">Registrar Nuevo Docente</h3>
        ...
        <form action="{{ route('docentes.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="rda" required placeholder="Registro Docente Administrativo"
                    class="w-full rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
            </div>
            ...
            <div>
                ...
                <input type="text" name="antiguedad" required placeholder="Ej. 5 años"
                    class="w-full rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
            </div>
