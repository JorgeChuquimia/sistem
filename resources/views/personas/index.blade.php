    ...
    <div class="space-y-6" x-data="{
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                <h3 class="font-bold text-gray-800 text-lg">Lista de Personas Registradas</h3>
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Nombre
                                Completo</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase">CI</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Celular</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Profesión</th>
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Usuario
                                Vinculado</th>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right space-x-3">
                                    <button
                                        @click="openEditModal = true; 
                                                ...
                                                editApellidos = '{{ $persona->apellidos }}'; 
                                                editCi = '{{ $persona->ci }}'; 
                                                editFechaNacimiento = '{{ $persona->fecha_nacimiento }}'; 
        ...
        @include('personas.modals.edit')
        @include('personas.modals.delete')
