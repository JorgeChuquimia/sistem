                    ...
                    <tbody class="bg-white divide-y divide-gray-100 text-sm">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right space-x-3">
                                ...
                                <button
                                    @click="openDeleteModal = true; deleteId = '{{ $asignacion->id_asignacion }}'; deleteNombre = 'Docente: {{ $asignacion->docente->persona->nombres ?? '' }} {{ $asignacion->docente->persona->apellidos ?? '' }} - Materia: {{ $asignacion->materia->nombre_materia ?? '' }}'"
