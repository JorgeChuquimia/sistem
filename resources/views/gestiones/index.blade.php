    ...
    <div class="space-y-6" x-data="{
        ...
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                <h3 class="font-bold text-gray-800 text-lg">Lista de Gestiones</h3>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Año / Gestión
                            </th>
                        ...
                        @forelse ($gestiones as $gestion)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right space-x-3">
                                    <button
                                        @click="openEditModal = true; editId = '{{ $gestion->id_gestion }}'; editGestion = '{{ $gestion->gestion }}'"
                                        class="text-indigo-600 hover:text-indigo-900 font-medium">Editar</button>
                                    <button
                                        @click="openDeleteModal = true; deleteId = '{{ $gestion->id_gestion }}'; deleteNombre = '{{ $gestion->gestion }}'"
                                        class="text-red-600 hover:text-red-900 font-medium">Eliminar</button>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="3" class="px-6 py-4 text-center text-gray-500">No hay gestiones
                                    registradas.</td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        <!-- Modales -->
        @include('gestiones.modals.create')
        @include('gestiones.modals.edit')
        @include('gestiones.modals.delete')
    </div>
</x-app-layout>
