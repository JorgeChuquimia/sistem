<div x-show="openDeleteModal" x-transition:enter="transition ease-out duration-300"
    ...
    <div @click.away="openDeleteModal = false"
        ...
        <div class="mb-4 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-xl text-sm">
            <p class="font-semibold">¿Estás seguro de eliminar esta gestión?</p>
            <p class="mt-1">El registro del año <span class="font-bold underline" x-text="deleteNombre"></span> será eliminado del sistema.</p>
        </div>

        <form :action="`/gestiones/${deleteId}`" method="POST">
            @csrf
            @method('DELETE')
