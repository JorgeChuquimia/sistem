<x-app-layout>
    ...
    <div class="space-y-6" x-data="{
        ...
        <!-- Resto de tu tabla y modales de Grados -->
        <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
            <div class="p-6 border-b border-gray-100 flex justify-between items-center">
                <h3 class="font-bold text-gray-800 text-lg">Lista de Grados Académicos</h3>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-left text-xs font-semibold text-gray-500 uppercase">Nivel / Gestión</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-100 text-sm">
                        ...
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap text-gray-500 font-medium">{{ $grado->id_grado }}</td>
                            <td class="px-6 py-4 whitespace-nowrap font-semibold text-gray-900">
                                {{ $grado->nivel->nivel ?? '-' }} ({{ $grado->nivel->gestion->gestion ?? '-' }})
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap font-semibold text-gray-900">{{ $grado->curso }}</td>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="px-6 py-4 text-center text-gray-500">No hay grados registrados.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
