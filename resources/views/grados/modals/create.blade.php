<div x-show="openCreateModal" x-transition:enter="transition ease-out duration-300"
    ...
    <div @click.away="openCreateModal = false"
        ...
        <div class="flex justify-between items-center mb-4">
            <h3 class="text-lg font-bold text-gray-900">Registrar Nuevo Grado</h3>
        ...
        <form action="{{ route('grados.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="curso" required placeholder="Ej. 1ro de Secundaria"
                    class="w-full rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
            </div>

            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Paralelo</label>
                <input type="text" name="paralelo" required placeholder="Ej. A o B"
                    class="w-full rounded-xl border-gray-200 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
            </div>
