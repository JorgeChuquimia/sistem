        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
                <div>
                    ...
                    <span class="text-xs font-medium text-green-600 bg-green-50 px-2 py-0.5 rounded-full">+4% este
                        mes</span>
                </div>
                <div
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
                ...
                <div
                    class="w-12 h-12 bg-purple-50 text-purple-600 rounded-xl flex items-center justify-center text-xl shadow-sm">
                    👩‍🏫
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
                <div>
                    ...
                    <span class="text-xs font-medium text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-full">Plan de
                        estudios</span>
                </div>
                <div
                    class="w-12 h-12 bg-indigo-50 text-indigo-600 rounded-xl flex items-center justify-center text-xl shadow-sm">
                    📚
                </div>
            </div>
            ...
            <div class="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex items-center justify-between">
                <div>
                    ...
                    <span class="text-xs font-medium text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full">En
                        curso</span>
                </div>
                <div
                    class="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center text-xl shadow-sm">
                    📅
                </div>
            </div>
        ...
        <div class="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm">
            <div class="max-w-3xl">
                ...
                <p class="text-gray-600 text-sm leading-relaxed mb-6">
                    ...
                    institución educativa de forma segura.
                </p>
            </div>
        </div>
    </div>
